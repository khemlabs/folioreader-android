...
public final class SMILParser {
	...
	/**
	 * Function creates list {@link OverlayItems} of all tag elements from the input
	 * html raw string.
	 *
	...
	/**
	 * [RECURSIVE] Function recursively finds and parses the child elements of the
	 * input DOM element.
	 *
	...
	/**
	 * function finds all the text content inside input html page and splits each
	 * sentence with separator '.' and returns them as a list of
	 * {@link OverlayItems}
	 *
	...
	/**
	 * [RECURSIVE] Function recursively looks for the child element with the text
	 * content and adds them to the input {@link OverlayItems} list
	 *
	 * @param names   input {@link OverlayItems} where data is to be stored
	 * @param section input DOM element
	 */
